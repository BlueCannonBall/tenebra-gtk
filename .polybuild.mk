...
ifeq ($(OS),Windows_NT)
	...
	cpp_compilation_flags := /W3 /std:c++latest /EHsc /DWIN32_LEAN_AND_MEAN /DNOMINMAX /I"fltk/build" /I"$(OPENSSL_ROOT_DIR)"/include /O2 $(active_debug_compilation_flag) $(include_path_flag)fltk $(active_dynamic_flag)
